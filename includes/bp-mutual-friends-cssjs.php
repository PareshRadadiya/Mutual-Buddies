...
function bp_mutual_friends_add_js() {
	...
	if ( ! defined( 'DOING_AJAX' )   ) {
		...
		wp_enqueue_script( 'mutual-friends', BP_MUTUAL_FRIENDS_PLUGIN_URL.'assets/js/bp-mutual-friends'.$suffix.'.js', array('jquery', 'jquery.magnific-popup' ), BP_MUTUAL_FRIENDS_VERSION );
	}
}
